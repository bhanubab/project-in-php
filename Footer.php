...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Jalandhar - Delhi G.T. Road, Phagwara, Punjab 144411</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>sbbfcc@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 7740039585</p><br><br><br>
     <center><img src="image/devlop/img1.png"class="img1-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Develope By BhanuShivi@| All Rights Reserved 2020</p>
</footer>
